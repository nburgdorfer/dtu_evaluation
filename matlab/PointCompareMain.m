function BaseEval=PointCompareMain(cSet,Qdata,Qstl,dst,dataPath)
...
MaxDist=60;
disp('Computing distances from estimated to ground-truth...')
Ddata = MaxDistCP(Qstl,Qdata,BB,MaxDist);

disp('Computing distances from ground-truth to estimated...')
